...
#ifdef __APPLE__
  fprintf(stderr,
          "FEXDBG_CORE: ExecuteThread RIP=0x%llx RSP=0x%llx "
          "ThunkCallbackRet=0x%llx SignalReturnHandler=0x%llx SignalReturnHandlerRT=0x%llx "
          "GlobalMemoryBase=0x%llx\n",
          static_cast<unsigned long long>(Thread->CurrentFrame->State.rip),
          static_cast<unsigned long long>(Thread->CurrentFrame->State.gregs[FEXCore::X86State::REG_RSP]),
          static_cast<unsigned long long>(Thread->CurrentFrame->Pointers.ThunkCallbackRet),
          static_cast<unsigned long long>(Thread->CurrentFrame->Pointers.SignalReturnHandler),
          static_cast<unsigned long long>(Thread->CurrentFrame->Pointers.SignalReturnHandlerRT),
...
ContextImpl::CreateThread(uint64_t InitialRIP, uint64_t StackPointer, const FEXCore::Core::CPUState* NewThreadState) {
  ...
  const_cast<FEXCore::Core::CpuStateFrame*&>(Thread->CurrentFrame) = &Thread->BaseFrameState;
