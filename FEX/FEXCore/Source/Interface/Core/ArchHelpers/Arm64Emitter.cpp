...
namespace x64 {
...
#ifdef __APPLE__
  // On macOS, x16 and x17 are used for veneers and x18 is reserved for TSD.
  // We must avoid using them for fixed guest registers that are not spilled across all calls.
  constexpr std::array<ARMEmitter::Register, 18> SRA = {
    ARMEmitter::Reg::r4,  // 0: RAX
    ARMEmitter::Reg::r7,  // 1: RDI
    ARMEmitter::Reg::r5,  // 2: RCX
    ARMEmitter::Reg::r6,  // 3: RDX
    ARMEmitter::Reg::r8,  // 4: R8
    ARMEmitter::Reg::r9,  // 5: R9
    ARMEmitter::Reg::r10, // 6: R10
    ARMEmitter::Reg::r11, // 7: R11
    ARMEmitter::Reg::r12, // 8: R12
    ARMEmitter::Reg::r13, // 9: R13
    ARMEmitter::Reg::r14, // 10: R14
    ARMEmitter::Reg::r15, // 11: R15
    ARMEmitter::Reg::r19, // 12: R12 (Guest) -> Host x19
    ARMEmitter::Reg::r20, // 13: R13 (Guest) -> Host x20
    ARMEmitter::Reg::r21, // 14: R14 (Guest) -> Host x21
    ARMEmitter::Reg::r22, // 15: R15 (Guest) -> Host x22
    // PF/AF must be last.
    REG_PF,
    REG_AF,
  };
  ...
  constexpr std::array<ARMEmitter::Register, 5> RA = {
    // x19 is callee saved, but FEX uses it for SRA.
    // x20-x22 are callee saved and used for SRA on macOS.
    // x23-x24 are callee saved.
    // x25 is callee saved, used for call-return stack role on macOS.
    // x16-x17 are used for veneers but safe for dynamic RA since it spills across calls.
    // x30 is NOT callee saved.
    ARMEmitter::Reg::r23, ARMEmitter::Reg::r24, ARMEmitter::Reg::r16, ARMEmitter::Reg::r17, ARMEmitter::Reg::r30,
  };
#else
...
#ifdef __APPLE__
  // Dynamic GPRs
  constexpr std::array<ARMEmitter::Register, 3> PreserveAll_Dynamic = {
...
#ifdef __APPLE__
  constexpr std::array<ARMEmitter::Register, 3> NotPreserved_Dynamic = PreserveAll_Dynamic;
#else
